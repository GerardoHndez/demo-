...
class alumno {
  ...
  modificar () {
    ...
    console.log(`${colors.yellow.bold('Nombre:')} ${colors.white(alumno.nombre)}`)
    console.log(`${colors.yellow.bold('Apellido Paterno:')} ${colors.white(alumno.apellidoPaterno)}`)
    console.log(`${colors.yellow.bold('Apellido Materno:')} ${colors.white(alumno.apellidoMaterno)}\n`)
